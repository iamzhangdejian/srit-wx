...
<div class="funcList" id="func">
    <ul class="list">
        ...
        <a href="sworkController.do?goPage&page=main" target="_blank">
            <li>
        ...
        <%--               <a href="cmsController.do?goPage&page=photoAlbum" target="_blank">
                       ...
                       <li>
                           ...
                           <h3>微投票</h3>
                           <p>商家设置好题目，<br> 用户通过微信问答<font color="red">[商业版提供]</font></p>
                       </li>
                       <li>
                           <img src="./plug-in/weixin/img/func14.jpg">
                           <h3>微信墙 </h3>
                           <p>活跃现场气氛，让粉丝涨起来<font color="red">[商业版提供]</font></p>
                       </li>
                       <li>
                           <img src="./plug-in/weixin/img/func15.jpg">
                           <h3>微社区</h3>
                           <p>移动社区交流<font color="red">[商业版提供]</font></p>
                       </li>
                        <li>
                           <img src="./plug-in/weixin/img/func02.jpg" width="105" height="107">
                           <h3>会员卡</h3>
                           <p>方便携带 永不挂失<br>消费积分 一卡配备<font color="red">[商业版提供]</font></p>
                       </li>
                       <li>
