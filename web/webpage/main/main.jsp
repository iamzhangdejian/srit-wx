...
<!-- 顶部-->
<div region="north" border="false" title="国研软件微信公众平台"
     style="BACKGROUND: #4682B4; height: 85px; padding: 1px; overflow: hidden;">
                ...
                <table>
                    <tr>
                        <td valign="top" height="50"><span style="color: #CC33FF">当前用户:</span><span
                                style="color: #666633">(${userName }) <span style="color: #CC33FF">职务</span>:<span
                                style="color: #666633">${roleName
                                }</span></td>
                    </tr>
                    <td>
                        <div style="position: absolute; right: 0px; bottom: 0px;"><a href="javascript:void(0);"
                                                                                     class="easyui-menubutton"
                                                                                     menu="#layout_north_kzmbMenu"
                                                                                     iconCls="icon-help">控制面板</a><a
                                href="javascript:void(0);" class="easyui-menubutton" menu="#layout_north_zxMenu"
                                iconCls="icon-back">注销</a></div>
...
<div collapsed="true" region="east" iconCls="icon-reload" title="辅助工具" split="true" style="width: 190px;"
    ...
    <div region="south" border="false" style="height: 25px; overflow: hidden;">
        <div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a
                href="http://www.sritsoft.com/index.html" title="微信公众账号平台">微信公众账号平台</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a
                href="http://www.sritsoft.com/index.html" title="国研软件">国研软件</a> </span></div>
    </div>
