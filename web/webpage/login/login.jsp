...
<div class="text_success"><img src="plug-in/login/images/loader_green.gif" alt="Please wait"/> <span>登陆成功!请稍后....</span>
</div>
<div id="login">
    ...
    <div class="inner">
        ...
        <div class="formLogin">
            <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser"
                ...
                <div class="tip">
                    <input class="userName" name="userName" type="text" id="userName" title="用户名" iscookie="true"
                           value="admin" nullmsg="请输入用户名!"/>
                </div>
                <div class="tip">
                    <input class="password" name="password" type="password" id="password" title="密码" value="123456"
                           nullmsg="请输入密码!"/>
                </div>
                <div class="tip">
                    <input class="randCode" name="randCode" type="text" id="randCode" title="" value=""
                           nullmsg="请输入验证码!"/>
                ...
                <div>
                    <div style="float: right; margin-left:-220px; margin-right: 40px;">
                        技术支持： <font color="red">数字城市部</font> &nbsp;&nbsp;&nbsp; 咨询QQ: <font
                            color="red">888888888</font> &nbsp;&nbsp;&nbsp; 官网: <font color="red"><a
                            href="http://www.sritsoft.com/index.html" target="_blank">www.sritsoft.com</a></font>
                    </div>
                </div>
            </form>
        </div>
...
<div class="clear"></div>
<div id="versionBar">
    <div class="copyright">&copy; 版权所有 <span class="tip"><a href="http://www.sritsoft.com/index.html" title="北京国研数通软件技术有限公司"
                                                            target="_blank">北京国研数通软件技术有限公司</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度) 技术支持: <a
            href="http://www.sritsoft.com/index.html" title="数字城市部" target="_blank">数字城市部</a></span></div>
</div>
<!-- Link JScript-->
